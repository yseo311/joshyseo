...
> #####"_Tell Them the **NORTH** Remembers_"
...
> _This stuffed flatbread is a Sicilian specialty from the province of Ragusa, made with a very thin rectangular layer of dough that¡¯s folded in on itself a few times to make a veritable mille-feuille of a pie, with a dozen stunning layers greeting you when you, lucky you, cut into it. Not all scaccias have these thin folded layers; usually only the tomato and cheese ones do, while others have fillings from ricotta and fried eggplant, ricotta and sausage, greens, beans and more, folded over and crimped at the edges, sometimes elaborately with a braid, like a giant empanada._
